...
const NavigatorRegister: React.FC<InterfaceNavigatorRegister> = ({ selected}) => {
  ...
  return (
    <ContainerTilePage>
      ...
      <li style={{backgroundColor: window.location.pathname === '/dashboard/werehouse' ? '#3B5BDB' : '#FFF', color: window.location.pathname === '/dashboard/werehouse' ? '#FFF' : '' }} onClick={() => {history.push('/dashboard/werehouse')}}>Warehouse</li>
